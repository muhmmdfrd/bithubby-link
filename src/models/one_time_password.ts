...
export type one_time_passwordOptionalAttributes =
  | 'id'
  | 'otp'
  | 'created_by'
  | 'created_date'
  | 'updated_by'
  | 'updated_date';
export type one_time_passwordCreationAttributes = Optional<
  one_time_passwordAttributes,
  one_time_passwordOptionalAttributes
>;

export class one_time_password
  extends Model<
    one_time_passwordAttributes,
    one_time_passwordCreationAttributes
  >
  implements one_time_passwordAttributes
{
  id!: number;
  user_id!: number;
  otp?: string;

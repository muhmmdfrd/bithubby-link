...
export type user_sessionOptionalAttributes =
  | 'refresh_token'
  | 'created_date'
  | 'updated_date';
export type user_sessionCreationAttributes = Optional<
  user_sessionAttributes,
  user_sessionOptionalAttributes
>;

export class user_session
  extends Model<user_sessionAttributes, user_sessionCreationAttributes>
  implements user_sessionAttributes
{
  user_id!: number;
  refresh_token?: string;
  created_date?: Date;

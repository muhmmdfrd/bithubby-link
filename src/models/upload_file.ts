...
export type upload_fileOptionalAttributes =
  | 'id'
  | 'reference_id'
  | 'original_file_name'
  | 'file_name'
  ...
  | 'updated_date'
  | 'url';
export type upload_fileCreationAttributes = Optional<
  upload_fileAttributes,
  upload_fileOptionalAttributes
>;

export class upload_file
  extends Model<upload_fileAttributes, upload_fileCreationAttributes>
  implements upload_fileAttributes
{
  id!: number;
  reference_id?: number;
  original_file_name?: string;
